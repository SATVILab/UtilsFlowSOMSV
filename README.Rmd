...
The goal of flowsomutils is to provide support functions for assessing and working with FlowSOM output

## Installation

You can install the development version of flowsomutils from [GitHub](https://github.com/) with:
